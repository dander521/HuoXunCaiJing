...
- (void)sd_small_setImageWithURL:(nullable NSURL *)url
    ...
    NSString *resultString = [NSString stringWithFormat:@"%@?x-oss-process=image/resize,m_lfit,w_%zd",urlString,(int)SCREEN_WIDTH*2];
    [self sd_setImageWithURL:[NSURL URLWithString:resultString] forState:state placeholderImage:placeholder options:0 completed:nil];
}
