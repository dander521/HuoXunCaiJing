...
- (void)loadBigImageWithBrowseItem:(MSSBrowseModel *)browseItem cell:(MSSBrowseCollectionViewCell *)cell rect:(CGRect)rect
{
    ...
    if (browseItem.smallImageView == nil) {
        ...
        imageDefault = [UIImage imageNamed:@"goods"];
    } else {
    ...
    [imageView sd_setImageWithURL:[NSURL URLWithString:browseItem.bigImageUrl] placeholderImage:imageDefault completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
