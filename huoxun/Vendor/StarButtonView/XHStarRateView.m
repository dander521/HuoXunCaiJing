...
#define ForegroundStarImage @"ic_main_star_solid"
#define BackgroundStarImage @"ic_main_star_comment"
#define CommentStarImage @"ic_main_star_comment"
...
- (void)setIsGrayStarForBlank:(BOOL)isGrayStarForBlank {
    if (_isGrayStarForBlank == isGrayStarForBlank) {
        return;
    }
    _isGrayStarForBlank = isGrayStarForBlank;

    NSString *image = _isGrayStarForBlank ? CommentStarImage : BackgroundStarImage;
    
    [self.backgroundStarView removeAllSubViews];
    self.backgroundStarView = [self createStarViewWithImage:image];
    [self insertSubview:self.backgroundStarView atIndex:0];
